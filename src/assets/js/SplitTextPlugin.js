...
//       if ($(".blank").css("white-space") !== "pre" || options.useCSS == false) {
//         // check if style exists //
//         //console.log('style doesnt exist - add it!'+$(".blank").css('white-space'));

//         $(
//           "<style rel='splitStyle'>" +
//             ".splitText{max-width: 100%;float: none;margin-top: 0px;margin-left: 0px;}" +
//             ".splitText>div{white-space:pre-line;float:none;display:inline-block;margin-right:0px;cursor:default;}" +
...
//         var item = "<div class='split-lines-outer'><div class='split-lines'>" + value.text + "</div></div>";
...
//         var word = words[j];
//         var isSentenceEnd = regExp.test(word);
//         if (isSentenceEnd) {
...
//             TMax.insert(TweenMax.to($(this), options.duration, getAnimation(options, w)), "-=0.45");
//           } else {
//             var pos = $(this).offset();
